...
def calc_emissions(transport_mode, transport_km, electricity_kwh, diet_type, meals_per_day, clothes_per_month, electronics_per_year, fish, chicken, veggies):
    ...
    food_kg = ef_map.get("fish", 27.0)*fish + ef_map.get("Chicken", 6.9)*chicken + ef_map.get("Veggies", 2.0)*veggies
...
ml_ready = syn.copy()
if not syn.empty:
    features = ["transport_mode","transport_km_day","electricity_kwh_day","diet_type","meals_per_day","clothes_per_month","electronics_per_year",fish"_kg_day","chicken_kg_day","veggies_kg_day"]
    target = "em_total"
...
if model is not None:
    try:
        ...
        final_features = ohe_features + ["transport_km_day","electricity_kwh_day","meals_per_day","clothes_per_month","electronics_per_year","fish","chicken_kg_day","veggies_kg_day"]
